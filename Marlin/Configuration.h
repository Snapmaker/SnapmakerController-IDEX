...
#define EXTRUDERS_MIN_DISTANCE 24  // mm
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  18.3,  18.3 }
    #define DEFAULT_Ki_LIST {  1.09,  1.09 }
    #define DEFAULT_Kd_LIST { 76.75, 76.75 }
  #else
    // #define DEFAULT_Kp 14.18
    // #define DEFAULT_Ki 0.80
    // #define DEFAULT_Kd 62.45
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 138.58 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 350, 350, 10, 80 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 12000, 12000, 600, 6000 }
...
#define DEFAULT_ACCELERATION_TO_DECELERATION_RATIO  50    // X, Y, Z acceleration for travel (non printing) moves
 ...
 */
  ...
  #define CORNER_VELOCITY 25 // (mm) 90 degree angular velocity
